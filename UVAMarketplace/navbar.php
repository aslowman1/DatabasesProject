...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <a class="navbar-brand" href="home.php" style="font-family: Lucida Console, Courier New, monospace; padding: 15px; font-size:25px;">UVA Marketplace</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">   
        <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" href="createListing.php" style="color: white;">Create Listing</a>
        </li>                                                  
